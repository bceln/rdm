...
Anyone can contribute to this website. Doing so requires a [Github account](https://github.com).

The pages here are written in [Markdown](https://www.markdownguide.org/basic-syntax/), a simple text processing language that is easy to learn. [If not familiar with Markdown, follow this tutorial](https://www.markdowntutorial.com/).

The codebase is at the [RDM github repository](https://github.com/bceln/rdm), and the pages are displayed with [MKdocs](https://www.mkdocs.org/user-guide/writing-your-docs/). 

Follow the [MKdocs documentation](https://www.mkdocs.org/user-guide/writing-your-docs/) for a detailed understanding of how the files are built and laid out.
...
1.  Navigate to the repository: <https://github.com/bceln/rdm>
2.  In the page header, click the Fork button to create your own copy of the repository. 

    ![Screenshot showing the Fork button in Github](/rdm/assets/fork-button.png)
...
3.  To make changes such as adding a new page, start by creating a new branch:
    -   Click the branch menu button (it should say "main")
       ...
       ![Screenshot showing the Branches menu in Github](/rdm/assets/branch-menu.png)

    -   Pick a name that's descriptive of your changes, and type it into the search bar.

        ![Screenshot showing how to create a new branch in Github](/rdm/assets/branch-switch.png)
...
7.  Adding new pages:
    -   Create your page:
        ...
        -   Click the Add File button, and "Create new file".\
            ![Screenshot showing the "Create new file" button](/rdm/assets/add-file.png)
    ...
    -   Add your new page to the site navigation structure:
        ...
        -   Follow the conventions of the other pages under that menu, paying attention to formatting and indentation. Format should be `- Page Title: path/to/page.md`.
          ...
          ![Screenshot showing a section of the mkdocs.yml file](/rdm/assets/yaml-list.png)
